/**
 * One lab: its equipment grid, lab-wide consumables, and (for managers) the
 * Excel importer. The lab id comes from the URL (`/labs/:labId`).
 */
...
import { canAddEquipmentToLab } from "../../business/permissions";
import {
  addEquipment,
  getEquipmentForLab,
  getLab,
