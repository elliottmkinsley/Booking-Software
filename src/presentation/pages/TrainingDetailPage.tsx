/**
 * One training: how to complete it, which gear it unlocks, and (for standard
 * users) a form to request that a reviewer mark it complete.
 *
 * `?from=<equipmentId>` is set when you arrive from an equipment page so the
 * back link can return you there instead of the catalog.
 */
...
import { getTrainersByIds } from "../../business/trainers";
import type { Account, Equipment } from "../../shared/types";
