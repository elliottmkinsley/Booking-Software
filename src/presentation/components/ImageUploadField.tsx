/**
 * Drag-and-drop picture picker used on lab and equipment forms.
 *
 * Chosen files are stored as data URLs in the mock store (not uploaded to a
 * server yet). The hint under the box explains the preferred crop and size.
 */
