/**
 * Create or edit a lab (name, description, picture). Passing `lab={null}`
 * means "add a new lab"; otherwise it updates the one you opened.
 */
import { useState, type FormEvent } from "react";
import { useAuth } from "../context/AuthContext";
import { addLab, updateLab } from "../../business/labs";
