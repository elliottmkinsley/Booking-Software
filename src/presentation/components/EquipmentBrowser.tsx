/**
 * Searchable grid of equipment or software cards, plus add/edit/remove for
 * people who manage that list. Used on a lab page (gear) and the main menu
 * (shared software).
 */
import {
  useEffect,
...
import { removeEquipment } from "../../business/labs";
import { getAllTrainings } from "../../business/trainings";
import type { Equipment, RentalGranularity, Training } from "../../shared/types";
import { equipmentImage } from "../../shared/utils/images";
import {
  RENTAL_GRANULARITY_LABELS,
  RENTAL_GRANULARITY_OPTIONS,
} from "../../shared/utils/rental";
