/**
 * Spreadsheet I/O for equipment import. Creating rows in the lab is a
 * business use-case (`business/equipmentImport.ts`).
 */
...
import { listEquipmentForLab } from "../repositories/equipment";
import { listPeople } from "../repositories/people";
import { listTrainerAccountIds } from "../repositories/trainers";
import { listTrainings } from "../repositories/trainings";
...
async function listTrainerAccounts(): Promise<Account[]> {
  const ids = await listTrainerAccountIds();
